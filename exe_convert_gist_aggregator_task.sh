...
sleep 1
./wzdnzd_aggregator.sh -a https://gist.github.com/zoecsoulkey/4fb494052c2398bdbd36df8d20fb600e -f gist_aggregator/zoecsoulkey_sub -l gist_aggregator/zoecsoulkey_sub/zoecsoulkey_log.txtsleep 1
sleep 1
